...
@section('title') Iniciar Sesión -  Osorio @endsection
...
@section('content')
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-center justify-content-center bg-white">
                <div class="w-100" style="max-width: 380px; padding: 2rem;">
                    ...
                    <div class="text-center mb-5">
                        <img src="{{ URL::asset('build/images/logo-dark.png') }}" alt=" Osorio" height="60" class="mb-3">
                    ...
                    <!-- Mensajes de error -->
                    @if($errors->any())
                        <div class="alert alert-danger alert-dismissible fade show border-0 shadow-sm" role="alert" style="background: linear-gradient(135deg, #0072c5, #0072c5); color: white;">
                    ...
                    <div class="text-center mt-5">
                        <p class="small text-muted mb-0">
                            ...
                            {{ date('Y') }}   Osorio. Todos los derechos reservados.
                        </p>
    ...
    <script>
        ...
        function fillDemoCredentials() {
            document.getElementById('email').value = 'demo@jesusosorio.com.ve';
